			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					if (txtAut.getText().isEmpty()
						...
						livro.setPrecoDeCusto(Double.parseDouble(txtPrecoCusto
								.getText()));
						livro.setMargemDeLucro(Double
								.parseDouble(txtMargemDeLucro.getText()));
						livro.setQuantidadeEmEstoque(Integer
								.parseInt(txtEstoque.getText()));
					...
					JOptionPane
							.showMessageDialog(null,
									"Dados Inválidos. Não foi possível cadastrar o Livro!");
					e.printStackTrace();
